...
#define LP_VEL_FILTER_COEFF			(0.25)
#define LP_TRQ_FILTER_COEFF			(0.25)
...
/* Caster measurements */
#define PC_r 						(0.051*0.995) 		// [m] -- Wheel radius  * Empirical_Cal_Factor
...
#define DIST_TO_CASTER_X 			0.2000     	// from cad. need to verify (Haley's old number: 0.1300) 0.1375
#define DIST_TO_CASTER_Y 			0.2147  	// from cad. need to verify (Haley's old number: 0.1325) 0.147114
...
#define PC_length					(0.62)              // [m]     -- length of vehicle along the x and y directions. Originally 0.465
